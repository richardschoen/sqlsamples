-- Query object statistics and last used
-- Retrieve object statistics for selected library
-- List All Objects and Fields in selected library Based on Last Used Date,
-- sorted descending by LIB, Last Used Time.
-- This will give us statistics on objects used in library.
-- Set the library name to replace @@LIBRARY or use with 
-- the QSHONI QSHQRYSRC command
SELECT
    OBJNAME,
    OBJTYPE,
    OBJATTRIBUTE,
